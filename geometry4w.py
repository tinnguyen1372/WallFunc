...
def create_geometry(square_size, air_size, rect_width, rect_height, wall_thickness):
    ...
    geometry[air_start + wall_thickness:air_end - wall_thickness, air_start + wall_thickness:air_end - wall_thickness] = 1  # Air is represented by 1
...
def save_image(filename, geometry, square_size, wall_color, air_color, object_color):
    ...
    plt.savefig('./Geometry_4W/' + filename, format='png', dpi=square_size/10, bbox_inches='tight', pad_inches=0)
    plt.close()
