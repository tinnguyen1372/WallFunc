...
def create_geometry(square_size, air_size, rect_width, rect_height, wall_thickness):
    ...
    geometry[air_start + 0:air_end - 0, air_start + 0:air_end - 0] = 1  # Air is represented by 1
...
def save_image(filename, geometry, square_size, wall_color, air_color, object_color):
    ...
    plt.savefig('./ObjectONLY/' + filename, format='png', dpi=square_size/10, bbox_inches='tight', pad_inches=0)
    plt.close()
...
if __name__ == '__main__':
    ...
    for i in range(args.n):
        ...
        params_filename = 'SL_ObjNoWall_{}_{}.npz'.format(args.start, args.end)
